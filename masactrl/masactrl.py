...
class MutualSelfAttentionControl(AttentionStore):
    MODEL_TYPE = {
        "SD": 16,
        "SDXL": 70
    }
    ...
    def forward(self, q, k, v, sim, attn, is_cross, place_in_unet, num_heads, **kwargs):
        ...
        if attn.requires_grad or is_cross or self.cur_step not in self.step_idx or self.cur_att_layer // 2 not in self.layer_idx:
